#!/usr/bin/env python3
"""
Experiment: UNet + EfficientNet-B1

Same configuration as baseline (B4) but with B1 encoder.
...
def main():
    print("="*80)
    print("EXPERIMENT: UNet + EfficientNet-B1")
    print("="*80)
    print()
    ...
    config.encoder_name = "efficientnet-b1"  # <<< ONLY CHANGE
    ...
    print(f"This (B1) CV:     {mean_dice:.4f}")
    ...
    print(f"This (B1) Test:      {test_results['mean_dice']:.4f}")
