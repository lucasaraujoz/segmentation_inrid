#!/usr/bin/env python3
"""
Quick test for B5: Train 1 fold for 2 epochs, test save/load/eval pipeline
"""
...
def main():
    print("="*80)
    print("QUICK TEST: B5 Pipeline (1 fold, 2 epochs)")
    print("="*80)
    ...
    config.checkpoint_dir = os.path.join(config.output_dir, "checkpoints", "efficientnet_b5_test")
    ...
    print("\n" + "="*80)
    print("✅ ALL TESTS PASSED - B5 pipeline working correctly")
    print("="*80)
